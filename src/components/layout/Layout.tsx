...
import {
  ...
  User, History, Menu, X, ChevronRight, BookOpen, Radio, Bell, Star, BarChart2, Film, Trophy, MonitorPlay, Box, Swords, GraduationCap, Award, Heart, Crown, Clock,
} from 'lucide-react';
  ...
  const studentLinks: NavItem[] = [
    ...
    ...(canViewSQLRace
      ? [
          ...
          { to: '/student/sql-exam',        icon: <GraduationCap size={18} />, label: 'SQL Certificate', isNew: true },
          { to: '/student/skill-passport',  icon: <Award size={18} />,         label: 'Skill Passport',  isNew: true },
        ]
      : []),
    { to: '/hall-of-fame',          icon: <Crown size={18} />, label: 'Hall of Fame' },
    { to: '/student/kudos',         icon: <Heart size={18} />, label: 'Kudos' },
    { to: '/student/time-capsule',  icon: <Clock size={18} />, label: 'Time Capsule', isNew: true },
    { to: '/alumni',                icon: <Users size={18} />, label: 'Alumni Wall',  isNew: true },
    ...(canViewDailyDuel
      ? [
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1">
              ...
              {erMcqBadge && role === 'student' && (
                <Star size={11} className="fill-amber-500 text-amber-500 stroke-0 shrink-0" />
              )}
            </div>
