...
const LESSONS: {
  ...
  {
    to: '/intro-to-sisp',
    eyebrow: 'MBI800 · Lesson 1',
    title: 'Introduction and Systems Thinking',
    body: 'The whole first lesson: what strategic planning actually decides, systems against collections, a sales loop you can run for twelve months to see why the obvious fix rebounds, and the Iceberg Model taken down through a real outage. Ends with a knowledge check. No login, nothing to install.',
    emoji: '🧊',
    from: '#514ca8',
    to2: '#0f766e',
  },
  {
    ...
    eyebrow: 'MBI804 · Lesson 1',
    title: 'What a Project Is, and What Decides How to Run It',
    body: 'The whole first lesson: pin two corners of the constraint triangle and watch the third move, slide a delay along a real schedule to find out which tasks the launch date cares about, choose between Agile, Waterfall and PRINCE2 across four project shapes, then price a risk on the grid. Ends with a knowledge check.',
    emoji: '📐',
    from: '#ab355c',
    to2: '#c9a84c',
  },
