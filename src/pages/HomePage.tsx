...
const LESSONS: {
  ...
  },
  {
    ...
    eyebrow: 'MBI806B · Session 1',
    title: 'Welcome to Business Data Analytics with AI and ML',
    body: "Day 1, for absolute beginners: what AI and ML actually mean, where you already use them without noticing, how real decisions get made, and a first look at Power BI.",
    emoji: '📊',
    from: '#0f766e',
    to2: '#f59e0b',
  },
